      ...
      <!--  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 staff_body_gellary_left">
            ...
            <div class="gellary_block">
                <div class="gellary_block_left">
                    <img src="/wp-content/themes/pearlhealth/images/staff_body_gellary-staff1.png">
                </div>
        ...
        ON posts.ID=meta.post_id where posts.post_type='tmm' and meta.meta_key= '_tmm_head' and posts.post_status='publish' order by posts.post_date DESC limit 9 ");
