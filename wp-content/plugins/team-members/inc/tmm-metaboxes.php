...
function tmm_register_group_metabox() {
    ...
    $side_group->add_field( array(
        'name'    => __( 'Featured In Home Page', 'team-members' ),
        'id'      => $prefix . 'bio_alignment',
        'type'    => 'select',
        'options' => array(
            'yes'   => __( 'Yes', 'team-members' ),
            'no'   => __( 'No', 'team-members' ),
    ...
    $side_group->add_field( array(
        'name' => __( 'Last Row Centerd  ?', 'team-members' ).' <a class="wpd_tooltip" title="'.__( 'Last Row Centered ', 'team-members' ).'"><span class="wpd_help_icon dashicons dashicons-editor-help"></span></a>',
        'desc' => __( 'Check to enable', 'team-members' ),
