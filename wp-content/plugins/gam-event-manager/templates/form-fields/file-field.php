...
if ( ! empty( $field['ajax'] ) ) {
	wp_enqueue_script( 'gam-event-manager-ajax-file-upload' );
	$classes[] = 'gam-event-manager-file-upload';
}
?>
...
<small class="description">
	...
	<?php else : ?>
		<?php printf( __( 'Maximum file size: %s.', 'gam-event-manager' ), size_format( wp_max_upload_size() ) ); ?>
	<?php endif; ?>
</small>