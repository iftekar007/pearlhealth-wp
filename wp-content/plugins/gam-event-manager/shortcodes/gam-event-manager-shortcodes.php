...
/**
 * GAM_Event_Manager_Shortcodes class.
 */

class GAM_Event_Manager_Shortcodes {
	...
	*/
	...
	public function event_dashboard( $atts ) {
		...
		wp_enqueue_script( 'gam-event-manager-event-dashboard' );
		...
		$event_dashboard_columns = apply_filters( 'event_manager_event_dashboard_columns', array(
			...
			'event_title' => __( 'Title', 'gam-event-manager' ),
			'event_location' => __( 'Location', 'gam-event-manager' ),
			'event_start_date' => __( 'Start Date', 'gam-event-manager' ),
			'event_end_date' => __( 'End Date', 'gam-event-manager' ),
			'view_count' => __( 'Viewed', 'gam-event-manager' ),
			'event_action' => __( 'Action', 'gam-event-manager' ), 
		) );
			...
			if ( $events->have_posts() ) : ?>
				...
				<?php if ( $events->found_posts > $per_page && $show_more ) : ?>
					...
					<?php else : ?>
						...
						<a class="load_more_events" id="load_more_events" href="#"><strong><?php _e( 'Load more listings', 'gam-event-manager' ); ?></strong></a>
...
new GAM_Event_Manager_Shortcodes(); ?>