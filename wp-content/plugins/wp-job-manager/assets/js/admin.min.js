...
jQuery(function()
{
console.log("in job listing admin");
jQuery('#job_listing_data').find('label[for="_job_location"]').html(jQuery('#job_listing_data').find('label[for="_job_location"]').html().replace('Location','Requirements'));
jQuery('#job_listing_data').find('label[for="_application"]').html(jQuery('#job_listing_data').find('label[for="_application"]').html().replace('Application Email or URL','Contact Email'));
jQuery('#job_listing_data').find('label[for="_company_name"]').html(jQuery('#job_listing_data').find('label[for="_company_name"]').html().replace('Company Name','Contact Person'));
jQuery('#job_listing_data').find('label[for="_company_website"]').html(jQuery('#job_listing_data').find('label[for="_company_website"]').html().replace('Company Website','Contact No'));
