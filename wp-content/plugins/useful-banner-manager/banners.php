...
<div class="wrap">
    ...
    if ( isset( $_GET[ $ubm_plugin_prefix . 'banner_id' ] ) && is_numeric( $_GET[ $ubm_plugin_prefix . 'banner_id' ] ) && $_GET[ $ubm_plugin_prefix . 'banner_id' ] > 0 ) {
        ...
        if ( empty( $banner ) ) {
            ...
            ?>
            <form method="post" enctype="multipart/form-data" id="add_banner">
              <table id="ubm_edit_banner">
                  ...
                  <tr>
                      <td width="25%" valign="middle"><strong><?php _e( 'Banner Title2', 'useful-banner-manager' ); ?></strong></td>
                      <td width="75%">
                          <input type="text" name="<?php echo( $ubm_plugin_prefix ); ?>banner_title2" id="<?php echo( $ubm_plugin_prefix ); ?>banner_title2" style="width: 300px" <?php if ( ! empty( $errors ) ) { echo( 'value="' . $banner_title2 . '"' ); } else { echo( 'value="' . $banner->banner_title2 . '"' ); } ?> /> <?php _e( '(required)', 'useful-banner-manager' ); ?>
                      </td>
                  </tr>


                  <tr>
                      <td width="25%" valign="middle"><strong><?php _e( 'Banner Desc', 'useful-banner-manager' ); ?></strong></td>
                      <td width="75%">
                          <input type="text" name="<?php echo( $ubm_plugin_prefix ); ?>banner_desc" id="<?php echo( $ubm_plugin_prefix ); ?>banner_desc" style="width: 300px" <?php if ( ! empty( $errors ) ) { echo( 'value="' . $banner_desc . '"' ); } else { echo( 'value="' . $banner->banner_desc . '"' ); } ?> /> <?php _e( '(required)', 'useful-banner-manager' ); ?>
                      </td>
                  </tr>
        ...
        ?>
        <form method="post" enctype="multipart/form-data" name="addbanner">
          <table id="ubm_add_banner">
              ...
              <tr>
                  <td width="25%" valign="middle"><strong><?php _e( 'Banner Title2', 'useful-banner-manager' ); ?></strong></td>
                  <td width="75%">
                      <input type="text" name="<?php echo( $ubm_plugin_prefix ); ?>banner_title2" id="<?php echo( $ubm_plugin_prefix ); ?>banner_title2" style="width: 300px" <?php if ( ! empty( $errors ) ){ echo( 'value="' . $banner_title2 . '"' ); } ?> /> <?php _e( '(required)', 'useful-banner-manager' ); ?>
                  </td>
              </tr>
              ...
              <tr>
                  <td width="25%" valign="middle"><strong><?php _e( 'Banner Desc', 'useful-banner-manager' ); ?></strong></td>
                  <td width="75%">
                      <input type="text" name="<?php echo( $ubm_plugin_prefix ); ?>banner_desc" id="<?php echo( $ubm_plugin_prefix ); ?>banner_desc" style="width: 300px" <?php if ( ! empty( $errors ) ){ echo( 'value="' . $banner_desc . '"' ); } ?> /> <?php _e( '(required)', 'useful-banner-manager' ); ?>
                  </td>
              </tr>
